...
class GoogleMap
{
     ...
     *
     * @param string $strBuffer Current frontend template buffer (replaceDynamicScriptTags HOOK)
     * @return string $strBuffer Modified frontend template buffer (replaceDynamicScriptTags HOOK)
     */
    public static function addAssets($strBuffer)
    {
        ...
        if (!isset($GLOBALS['TL_JAVASCRIPT']['googlemaps'])) {
            ...
            $strUrl = Url::addQueryString('language=' . $GLOBALS['TL_LANGUAGE'], $strUrl);
